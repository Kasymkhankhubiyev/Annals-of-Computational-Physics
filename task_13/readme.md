...
Положение уровня Ферми находится из уравнения: $N_{d}^+ + p = n$ (легирование донорами, основные носители - положительно заряженные ионы и протоны)

Услвие остановки: когда суммарный заряд $Q = N_{d}^{+} + p + n$ будет почти нулевой, т.е.:  $\frac{Q}{p + Nd^{+}}$~$0.0001$ - уровень Ферми найден
